    ...
    <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900  min-h-screen text-white font-sans flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="flex items-center space-x-4 mb-16 group animate-slideInDown">
        <div className="relative">
          <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-purple-500 via-blue-500 to-purple-600 flex items-center justify-center shadow-2xl group-hover:shadow-purple-500/50 transition-all duration-300 group-hover:scale-110">
            <span className="text-3xl font-bold">A</span>
          </div>
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-500 to-blue-500 opacity-0 group-hover:opacity-30 blur-xl transition-all duration-300"></div>
        </div>
        <div className="text-center">
          <span className="text-3xl font-bold bg-gradient-to-r from-white via-purple-100 to-blue-100 bg-clip-text text-transparent block">
            Animated Video Generator
          </span>
          <span className="text-sm text-purple-300 font-medium">Professional Animation Platform</span>
        </div>
      </div>
      <div className="w-full max-w-md bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl rounded-3xl border border-white/20 p-10 shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 animate-slideInUp">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-bold mb-3 bg-gradient-to-r from-white via-purple-100 to-blue-100 bg-clip-text text-transparent">
            Join Us Today
          </h2>
          ...
          <div className="group">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-all duration-300 group-focus-within:text-purple-400">
                <svg className="h-6 w-6 text-gray-400 group-focus-within:text-purple-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-10 pt-8 border-t border-gray-700/50 text-center">
          <p className="text-gray-400 text-lg">
            ...
            <a href="/login" className="text-purple-400 hover:text-purple-300 font-semibold transition-colors duration-300 hover:underline">
              Sign in here
            </a>
          </p>
        </div>
